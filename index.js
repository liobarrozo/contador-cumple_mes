...
function updateCounter() {
  ...
  changeTextPostCounter(meses); // Actualizamos el texto del H3
...
function changeTextPostCounter(meses) {
  const diaDelMes = new Date().getDate();
  const h3 = document.getElementById("text__post-counter");

  h3.textContent = `Gracias por estos ${meses} meses de mucho amor`;
}
